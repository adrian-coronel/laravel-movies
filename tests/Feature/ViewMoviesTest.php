...
class ViewMoviesTest extends TestCase
{
  ...
  */
  ...
  public function test_the_search_dropdown_works_correctly()
  {
    ...
    # Probamos el componente search-dropdown
    Livewire::test('search-dropdown') # Se crea una instancia del componente, para poder usar los siguientes metodos
      ->assertDontSee('jumanji')# verifica que el componenete no muestre el termino 'jumanji'
      ->set('search','jumanji')# Simula una busqueda, 'search' => variable de busqueda y 'jumanji' es el valor que le damos
      ->assertSee('Jumanji');# verifica que el componente muestre el término "Jumanji" después de realizar la búsqueda.
